...
asc_file <- here("Final_project", "data", "ctd_data", filename)  
#csv_file <- here("Final_project", "data", "ctd_data") 
...
# Write to a .csv file
write.csv(data, file = here("Final_project", "data", "ctd_data", 
                            paste(filename, ".csv")))
...
#Load Data
```{r}
CTD_A1 <- read_csv(here("Final_project", "data", "ctd_data", "km2315_A_1_200m.csv"))
CTD_A2 <- read_csv(here("Final_project", "data", "ctd_data", "km2315_A_2_200m.csv"))
CTD_B1 <- read_csv(here("Final_project", "data", "ctd_data", "km2315_B_1_250m.csv"))
CTD_B2 <- read_csv(here("Final_project", "data", "ctd_data", "km2315_B_2_250m.csv"))
CTD_C1 <- read_csv(here("Final_project", "data", "ctd_data", "km2315_C_1_250m.csv"))
CTD_C2 <- read_csv(here("Final_project", "data", "ctd_data", "km2315_C_2_250m.csv"))
CTD_D <- read_csv(here("Final_project", "data", "ctd_data", "km2315_D_1500m.csv"))
#CTD_wut <- read_csv(here("Final_project", "data", "ctd_data", "km2315_05_500m.csv"))
...
write_csv(CTD, here("Final_project", "data", "CTD.csv"))
...
# Load the Data
```{r}
fcm <- read_csv(here("Final_project", "data", "km2315_fcm_data.csv"), locale=locale(encoding="latin1"), skip = 2)

site_depth <- read_csv(here("Final_project", "data", "wells_dataframe.csv"))

#only keep the 1/4L(V)
# realevents = (include - hoechst junk - chlorophyll junk)
```
...
```{r}
write_csv(fcm, here("Final_project", "data", "fcm.csv"))
```
...
# Load the data
```{r}
CTD <- read_csv(here("Final_project", "data", "CTD.csv"))
fcm <- read_csv(here("Final_project", "data", "fcm.csv"))
```
...
```{r}
write.csv(CTD_FCM, here("Final_project", "data", "CTD_FCM.csv"))
```
